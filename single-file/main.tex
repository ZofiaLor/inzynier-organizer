...
\begin{figure}
\centering
\includegraphics[height=\textheight]{./UML-Users.png}
...
\begin{figure}
\centering
\includegraphics[height=\textheight]{./UML-Admin.png}
...
\begin{figure}
\centering
\includegraphics[height=\textheight]{./UML-Anonymous.png}
...
Wykorzystano również komponenty Angular Material \cite{bib:angularmaterial}, dzięki którym w prosty sposób uzyskać można estetycznie wyglądający interfejs graficzny, zgodny z wytycznymi Material Design firmy Google \cite{material}. Wykorzystanie gotowych komponentów pozwala na skupienie się na samej logice programu.
